...
export function PaperView({ text, font, inkColor, paperColor, onPaperClick, isTyping, lastKeystroke }: PaperViewProps) {
  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        animate={{
          rotateX: text.endsWith('\n') && lastKeystroke > Date.now() - 500 ? [0, -45, 0] : 0
        }}
